  ...
  return (
    <>
        <div id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
            <h4 className='text-center mb-2 text-lg navbar_name'>What I Offer</h4>
            <h2 className='text-center text-5xl navbar_name'>My Services</h2>
            <p className='text-center max-w-2xl mx-auto mt-5 mb-12 navbar_name'>I am a fullstack web developer from India with 4 years of experience in multiple companies.</p>
